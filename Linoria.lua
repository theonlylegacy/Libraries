...
local Library = {
    ...
    AccentColor = Color3.fromRGB(230, 230, 255);
...
do
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        DropdownOuter.InputBegan:Connect(function(Input)
            if Input.UserInputType == Enum.UserInputType.MouseButton1 and not Library:MouseIsOverOpenedFrame() and Info.SpecialType ~= 'Player' then
...
function Library:CreateWindow(...)
    ...
    function Window:AddTab(Name)
        ...
        local Middle = Library:Create('ScrollingFrame', {
            BackgroundTransparency = 1;
            BorderSizePixel = 0;
            Position = UDim2.new(0, 4 + 1, 0, 8 - 1);
